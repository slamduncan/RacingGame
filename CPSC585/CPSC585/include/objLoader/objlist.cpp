...
char list_is_full(objlist *listo)
{
	return(listo->item_count == listo->current_max_size);
}

void list_grow(objlist *old_listo)
{
	int i;
	objlist new_listo;
...
void list_make(objlist *listo, int start_size, char growable)
{
...
void* list_get_name(objlist *listo, char *name_to_find)
{
	int i = 0;
